...
class ChatVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //        moves view back down if tapped outside of keyboard
...
//        //        reloads message table data if a message is sent
...
//        }
        ...
        //        gets the data from completion handler
        SocketService.instance.getTyoingUsers { (typingUsers) in
        ...
        MessageService.instance.findAllChannel { (success) in
            if success {
                if MessageService.instance.channels.count  > 0 {
                    //if channels exist first one is selected by default
